...
from libs.utilities.generic import calculate_shapemodel, generate_image, save_image
...
if __name__ == '__main__':
	...
	gan_weights = stylegan2_voxceleb_256['gan_weights']
	channel_multiplier = stylegan2_voxceleb_256['channel_multiplier']
